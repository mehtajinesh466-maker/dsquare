  ...
  return (
    <section className="py-12 md:py-20 bg-white font-sans overflow-hidden">
      <div className="container mx-auto px-6 lg:px-20 max-w-6xl">
        ...
        <div className="relative bg-[#0a1118] rounded-[2.5rem] md:rounded-[4rem] p-8 md:p-12 lg:p-16 overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10 grid lg:grid-cols-12 gap-8 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
              ...
              {/* Trust Indicators */}
              <div className="flex flex-wrap justify-center lg:justify-start gap-6 pt-2 opacity-60">
            ...
            <div className="lg:col-span-5 flex flex-col gap-4">
              <motion.button 
                ...
                className="w-full py-5 rounded-2xl text-white font-black text-sm uppercase tracking-[0.2em] shadow-xl shadow-[#008d96]/20 flex items-center justify-center gap-3 transition-all group"
              >
                BOOK FREE DEMO
              ...
              <div className="grid grid-cols-2 gap-4">
                <a 
                  ...
                  className="py-4 bg-white/5 border border-white/10 rounded-2xl flex flex-col items-center justify-center gap-1 hover:bg-white/10 transition-all group"
                >
        ...
        <div className="mt-8 flex justify-between items-center px-4">
           ...
           <div className="flex gap-4">
              ...
              <div className="w-1 h-1 rounded-full bg-slate-200" />
              <div className="w-1 h-1 rounded-full bg-[#008d96]" />
           </div>
        </div>
