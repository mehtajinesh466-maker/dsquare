  ...
  return (
    <section className="relative w-full min-h-screen bg-white overflow-hidden flex flex-col md:flex-row items-center">
      ...
      <div className="relative w-full md:w-1/2 flex items-center justify-center p-6 md:p-12 order-2 md:order-1">
        ...
        */}
        <div className="relative z-10 w-full flex justify-center transform md:-translate-y-8 transition-transform duration-700">
          <img 
            src="/contact.png" 
        ...
        {/* Support Badge - Floating near the image */}


        {/* Minimal background watermark to anchor the free-floating image */}
        ...
        <div className="relative z-10 w-full max-w-xl">
          ...
          <div className="space-y-6 mb-12">
             <div className="flex items-center gap-5 group cursor-pointer">
                <div className="w-12 h-12 rounded-2xl bg-[#e6f4f5] flex items-center justify-center text-[#008d96] transition-all group-hover:bg-[#008d96] group-hover:text-white group-hover:-translate-y-1">
                   <Phone size={20} />
                </div>
                <div>
                   <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none mb-1">Call / WhatsApp</p>
                   <p className="text-base font-bold text-slate-900 group-hover:text-[#008d96] transition-colors">+91 95886 17808</p>
                </div>
             </div>
             
             <div className="flex items-center gap-5 group cursor-pointer">
                <div className="w-12 h-12 rounded-2xl bg-[#fff7ed] flex items-center justify-center text-orange-500 transition-all group-hover:bg-orange-500 group-hover:text-white group-hover:-translate-y-1">
                   <MapPin size={20} />
                </div>
                <div>
                   <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none mb-1">Our Centers</p>
                   <p className="text-base font-bold text-slate-900 group-hover:text-orange-600 transition-colors">Pune & Nashik, Maharashtra</p>
                </div>
             </div>
          </div>
